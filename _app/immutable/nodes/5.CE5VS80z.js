...
`)}
                ...
                <p>
                    ...
                    <ul>
                        ${e.map((n,m)=>`
                            <li>
                                <i>${n}<sup>T</sup></i> - ${(()=>{let C="".padEnd(s,"0");return C.substring(0,m)+"1"+C.substring(m+1)})()}
                            </li>
                            <li>
                                <i>${n}<sup>F</sup></i> - ${(()=>{let C="".padEnd(s,"0");return C.substring(0,m)+"1"+C.substring(m+1)})()}
                            </li>
                        `).join(`
`)}
                    </ul>
...
`)}
                ...
                <p>
                    <ul>
                        ${e.map((n,m)=>{const C=a.numbers[2*m],g=a.numbers[2*m+1];return`
                                <li> 
                                    <i>${n}<sup>T</sup></i> - ${C.value.join("")}
                                </li>
                                <li> 
                                    <i>${n}<sup>F</sup></i> - ${g.value.join("")}
                                </li>
                            `}).join(`
`)}
                    </ul>
