import"../chunks/DsnmJJEf.js";import"../chunks/BOSpDPoA.js";import{p as Z,f as w,K as ee,b as m,c as te,$ as oe,h as W,d as j,s as G,r as U,a as M,a9 as y}from"../chunks/CTrBG-su.js";import{i as se,s as ae,a as z,c as ne}from"../chunks/0-nxEys-.js";import{i as ie}from"../chunks/CVn46gxg.js";import{C as re,E as de,a as ce,R as le}from"../chunks/C-OFwKSu.js";import{C as he}from"../chunks/CCciNkN7.js";import{R as q}from"../chunks/BLjARmoN.js";import{R as ue,N as X,d as O,E as h,G as V,f as C,g as N,h as T,j as D,l as A,T as I,u as pe,m as $e,n as ge,o as fe,U as B,p as me,W as we,q as be,O as Ce,I as _e}from"../chunks/QFfqNP4o.js";import{C as ve}from"../chunks/xBHKOFPG.js";import{l as Ee}from"../chunks/Dw-FwYao.js";const Se=!0,qe=Object.freeze(Object.defineProperty({__proto__:null,prerender:Se},Symbol.toStringTag,{value:"Module"}));class ye extends ue{rowNodeCount;rowXOffset;varCount;clauseCount;clauseHeight;varHeight;yStep;yOffset;xDist=50;yDist=300;constructor(n){super(n);const{variables:c,clauses:t}=this.inInstance;this.varCount=c.length,this.clauseCount=t.length,this.clauseHeight=(this.clauseCount-.5)*this.yDist,this.varHeight=(this.varCount-1)*this.yDist,this.yStep=this.clauseHeight/Math.max(1,this.clauseCount-1),this.yOffset=(this.varHeight-this.clauseHeight)/2,this.rowNodeCount=3*t.length+3,this.rowXOffset=(this.rowNodeCount-1)/2*this.xDist}doReduce(){let n=[];const c=this.createVarGadgets(),t=this.createClauseGadgets(c.graph.copy());return n.push(...c.interSteps),n.push(...t.interSteps),{outInstance:t.graph,steps:n}}createClauseGadgets(n){const{clauses:c}=this.inInstance;let t=[],l=n.copy();return c.forEach((s,a)=>{const e=a+1,o=`${e}`,_={id:X+`${o}`,label:`\\kappa_{${e}}`,position:{x:2*this.rowXOffset,y:a*this.yStep+this.yOffset},classes:"clause"};l.addNode(_),n.addNode(_),s.literals.forEach(r=>{const b=`${r.varName}_${3*e}`,p=`${r.varName}_${3*e+1}`;r.negated?(n.addEdge({id:h+`${p}-${o}`,from:O+`${p}`,to:X+`${o}`,classes:"false_out"}),n.addEdge({id:h+`${o}-${b}`,from:X+`${o}`,to:O+`${b}`,classes:"false_in"})):(n.addEdge({id:h+`${b}-${o}`,from:O+`${b}`,to:X+`${o}`,classes:"true_out"}),n.addEdge({id:h+`${o}-${p}`,from:X+`${o}`,to:O+`${p}`,classes:"true_in"}))}),t.push({id:`connect-clause-node-${a}`,title:`Connect clause node "${o}" to variable row nodes`,description:`
                    <p>
            ...
            `,inSnapshot:this.inInstance,outSnapshot:l.copy()}),{graph:n,interSteps:t}}createVarGadgets(){const{variables:n}=this.inInstance;let c=new V,t=new V,l=[];return n.forEach((s,a)=>{if(a==0)t.addNode({id:C+N,label:"\\alpha",position:{x:0,y:a*this.yDist-this.yDist/2},classes:"source"}),t.addEdge({id:h+`${N}-${s}_1`,from:C+`${N}`,to:T+`${s}_1`,classes:"muted"}),t.addEdge({id:h+`${N}-${s}_${this.rowNodeCount}`,from:C+`${N}`,to:D+`${s}_${this.rowNodeCount}`,classes:"muted"});else{const e=`${n[a-1]}_${s}`;t.addNode({id:A+`${e}`,label:`(${n[a-1]}, ${s})`,position:{x:0,y:a*this.yDist-this.yDist/2},classes:"inbetween"});const o=n[a-1];t.addEdge({id:h+`${o}_1-${e}`,from:T+`${o}_1`,to:A+e,classes:"muted"}),t.addEdge({id:h+`${o}_${this.rowNodeCount}-${e}`,from:D+`${o}_${this.rowNodeCount}`,to:A+e,classes:"muted"}),t.addEdge({id:h+`${e}-${s}_1`,from:A+`${e}`,to:T+`${s}_1`,classes:"muted"}),t.addEdge({id:h+`${e}-${s}_${this.rowNodeCount}`,from:A+`${e}`,to:D+`${s}_${this.rowNodeCount}`,classes:"muted"})}for(let e=1;e<=this.rowNodeCount-1;e++){const o=`${s}_${e}`,_=`${s}_{${e}}`,r=`${s}_${e+1}`,b=`${s}_{${e+1}}`;let p="",R=O,x=O;e==1?(p+=" true",R=T):e==this.rowNodeCount-1?x=D:(e+1)%3==0&&(p+=" guarantee");const L={id:R+o,label:_,position:{x:(e-1)*this.xDist-this.rowXOffset,y:a*this.yDist},classes:p};if(c.addNode(L),t.addNode(L),e==this.rowNodeCount-1){const P={id:x+r,label:b,position:{x:e*this.xDist-this.rowXOffset,y:a*this.yDist},classes:"false"};c.addNode(P),t.addNode(P)}const F={id:h+`${o}-${r}`,from:R+`${o}`,to:x+`${r}`,classes:"muted"},k={id:h+`${r}-${o}`,from:x+`${r}`,to:R+`${o}`,classes:"muted"};c.addEdge(F),c.addEdge(k),t.addEdge(F),t.addEdge(k)}if(a==n.length-1){t.addNode({id:C+I,label:"\\beta",position:{x:0,y:a*this.yDist+this.yDist/2},classes:"target"}),t.addEdge({id:h+`${s}_1-${I}`,from:T+`${s}_1`,to:C+`${I}`,classes:"muted"}),t.addEdge({id:h+`${s}_${this.rowNodeCount}-${I}`,from:D+`${s}_${this.rowNodeCount}`,to:C+`${I}`,classes:"muted"});const e=-((this.rowNodeCount/2+1)*this.xDist);t.addEdge({id:h+`${I}-${N}`,from:C+`${I}`,to:C+`${N}`,classes:"muted target-to-source",controlPointDistances:[e,e]})}}),l.push({id:"create-variable-gadgets",title:"Create individual variable gadgets",description:`
                <p>
            ...
            `,inSnapshot:this.inInstance,outSnapshot:t.copy()}),{graph:t,interSteps:l}}}class K{decode(n,c){const{path:t}=c,l=new Map;for(let s=0;s<t.length;s++){const a=t[s].id;if(a.startsWith(T)){const e=a.substring(T.length,a.lastIndexOf("_"));l.has(e)||l.set(e,!0)}else if(a.startsWith(D)){const e=a.substring(D.length,a.lastIndexOf("_"));l.has(e)||l.set(e,!1)}}return new re(l)}}function Ne(H){return new Worker(""+new URL("../workers/WorkerHCYCLESolver-DnwjjcUn.js",import.meta.url).href,{name:H?.name})}var Ie=w('<meta name="description" content="Redcution from 3SAT to HCYCLE"/>'),Te=w("<h2>Input 3-SAT Instance</h2>"),De=w("<span>Certificate for 3-SAT will appear here.</span>"),Re=w("<h2>3-CNF Editor</h2>"),xe=w("<!> <!>",1),Le=w("<h2>Output HCYCLE Instance</h2>"),Oe=w('<span class="placeholder">Certificate for HCYCLE will appear here.</span>'),He=w("<!> <!>",1),Fe=w('<main class="svelte-1cz0gvf"><h1>3-SAT to HCYCLE reduction</h1> <div class="card-list svelte-1cz0gvf"><!> <!></div></main>');function Ve(H,n){Z(n,!1);const c=()=>z(o,"$redStore",l),t=()=>z(_,"$showStepper",l),[l,s]=ae(),a=(i,d=y)=>{_e(i,{get redStore(){return o},get hideCertificate(){return d()},title:g=>{var f=Te();m(g,f)},instance:(g,f=y)=>{le(g,{get cnf(){return f()}})},certificate:(g,f=y)=>{ce(g,{get cert(){return f()}})},certificatePlaceholder:g=>{var f=De();m(g,f)},$$slots:{title:!0,instance:!0,certificate:!0,certificatePlaceholder:!0}})};let e=pe(Ee.LS_3SAT_HCYCLE,new $e),{redStore:o,showStepper:_,isSolving:r,solveMessage:b,editorChanged:p,reduce:R,solve:x}=ge({storage:e,workerFactory:()=>new Ne,reducerFactory:i=>new ye(i),decoderFactory:()=>new K,createWorkerRequest:i=>({graph:i.toSerializedString()}),resolveWorkerResponse:i=>{const d=i;return me(d.type==we.RESULT),new ve(d.path)},onSolveFinished:(i,d)=>{if(d==B){ne(o,W(c).inCert=B,W(c));return}i.labelSolved({path:d.path,directed:!0,edgeIdUsesNodeIds:!1});const $=new K().decode(i,d);o.update(v=>(v.inCert=$,v.outCert=d,v.outInstance=i,v))}});ie();var L=Fe();ee(i=>{var d=Ie();oe.title="3SAT to HCYCLE",m(i,d)});var F=G(j(L),2),k=j(F);fe(k,{get redStore(){return o},get isSolving(){return r},get solveMessage(){return b},get showStepper(){return _},get reduce(){return R},get solve(){return x},title:u=>{var $=Re();m(u,$)},editor:u=>{de(u,{get cnf(){return c().inInstance},onChange:$=>p($),displayErrorMessages:!0})},$$slots:{title:!0,editor:!0}});var P=G(k,2);{var J=i=>{var d=xe(),u=M(d);a(u,()=>!0);var $=G(u,2);be($,{get redStore(){return o},get storage(){return e},instance:(Y,g=y,f=y)=>{q(Y,{get graph(){return g()},style:"3SAT-HCYCLE"})},$$slots:{instance:!0}}),m(i,d)},Q=i=>{var d=He(),u=M(d);a(u,()=>!1);var $=G(u,2);Ce($,{get redStore(){return o},title:E=>{var S=Le();m(E,S)},instance:(E,S=y)=>{q(E,{get graph(){return S()},style:"3SAT-HCYCLE"})},certificate:(E,S=y)=>{he(E,{get cert(){return S()}})},certificatePlaceholder:E=>{var S=Oe();m(E,S)},$$slots:{title:!0,instance:!0,certificate:!0,certificatePlaceholder:!0}}),m(i,d)};se(P,i=>{t()?i(J):i(Q,!1)})}U(F),U(L),m(H,L),te(),s()}export{Ve as component,qe as universal};
